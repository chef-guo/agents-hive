...
const pgDefaultPermissionRulesJSON = `[{"tool_name":"read_file","action":"allow"},{"tool_name":"filesystem","action":"allow"},{"tool_name":"write_file","action":"allow"},{"tool_name":"edit","action":"allow"},{"tool_name":"multiedit","action":"allow"},{"tool_name":"apply_patch","action":"allow"},{"tool_name":"glob","action":"allow"},{"tool_name":"grep","action":"allow"},{"tool_name":"ls","action":"allow"},{"tool_name":"websearch","action":"allow"},{"tool_name":"webfetch","action":"allow"},{"tool_name":"web_search","action":"allow"},{"tool_name":"web_fetch","action":"allow"},{"tool_name":"browser_interact","action":"allow"},{"tool_name":"skill","action":"allow"},{"tool_name":"skill_search","action":"allow"},{"tool_name":"task","action":"allow"},{"tool_name":"question","action":"allow"},{"tool_name":"batch","action":"allow"},{"tool_name":"todo_write","action":"allow"},{"tool_name":"enter_plan_mode","action":"allow"},{"tool_name":"exit_plan_mode","action":"allow"},{"tool_name":"finish_plan","action":"allow"},{"tool_name":"create_handoff_summary","action":"allow"},{"tool_name":"promote_todos_to_taskboard","action":"allow"},{"tool_name":"spawn_agent","action":"allow"},{"tool_name":"parallel_dispatch","action":"allow"},{"tool_name":"bash","action":"ask"},{"tool_name":"shell","action":"ask"},{"tool_name":"exec","action":"ask"},{"tool_name":"run_command","action":"ask"},{"tool_name":"create_tool","action":"ask"},{"tool_name":"remove_tool","action":"ask"},{"tool_name":"send_im_message","action":"allow"},{"tool_name":"feishu_api","pattern":"create_approval","action":"ask"},{"tool_name":"feishu_api","pattern":"create_bitable_record","action":"ask"},{"tool_name":"feishu_api","pattern":"create_task","action":"ask"},{"tool_name":"feishu_api","pattern":"complete_task","action":"ask"},{"tool_name":"feishu_api","pattern":"update_bitable_record","action":"ask"},{"tool_name":"feishu_api","pattern":"write_sheet","action":"ask"},{"tool_name":"feishu_api","action":"allow"},{"tool_name":"memory","pattern":"delete","action":"ask"},{"tool_name":"memory","action":"allow"},{"tool_name":"taskboard","pattern":"delete","action":"ask"},{"tool_name":"taskboard","action":"allow"},{"tool_name":"wenyan__preview_article","action":"allow"},{"tool_name":"wenyan__*","action":"ask"}]`
